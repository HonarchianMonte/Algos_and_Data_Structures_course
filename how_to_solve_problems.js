...
// 2. Coding Skills
// 3. Techinical Skills
// 4. Communicaiton Skills

// Learn the why we do things, that's what companies look for.


// Data Structures: Arrays, Stacks, Queues, Linked Lists, trees, Tries, Graphs, Hash Tables
// Algorithms: Sorting, Dynamic Porgramming, BFS + DFS (Searching), Recursion
// These above take care of most of what we need for a job, so employers will be happy to hire us if we know this well over others.
